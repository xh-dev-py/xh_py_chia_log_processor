...
def test_log():
    ...
    assert res.phase1.progress == round(100, 2)
    assert res.phase2.progress == round(100, 2)
    assert res.phase3.progress == round(100, 2)
    assert res.phase4.progress == round(100, 2)
